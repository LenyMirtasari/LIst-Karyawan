...
namespace ListKaryawanAPI.Tools {
    public static class StoredProcedureExecutor {
        public static async Task ExecuteScalarSFAsync (this DbContext context, string storedFunctionName, string parameters = "", string schema = "dbo") {
           // T returnObject = default();

            using (var command = context.Database.GetDbConnection().CreateCommand()) {
                command.CommandType = CommandType.Text;
                command.CommandText = $"SELECT {storedFunctionName}({parameters});";
        ...
        public static async Task ExecuteSPAsync(this DbContext context, string storedProcedureName, SqlParameter[] parameters)
        {
        ...
        /*
        public static async Task<T> ExecuteSPSingle<T>(this DbContext context, string storedProcedureName, SqlParameter[] parameters) {
            T returnObject = default(T);
        ...
        */
        ...
        public static async Task<List<T>> ExecuteViewListAsync<T>(this DbContext context, string viewName, SqlParameter[] parameters)
        {
            var returnObject = new List<T>();
